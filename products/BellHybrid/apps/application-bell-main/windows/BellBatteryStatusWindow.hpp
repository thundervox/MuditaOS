...
namespace gui
{
    ...
    class BellBatteryStatusWindow : public WindowWithTimer
    {
      public:
        struct Data : public gui::SwitchData
        {
            Data(std::uint32_t lvl, bool chargeState, bool lowBatteryWaring = false)
                : chargeLevel{lvl}, isCharging{chargeState}, isItLowBatteryWaring{lowBatteryWaring}
            {}
            const std::uint32_t chargeLevel;
            const bool isCharging;
            const bool isItLowBatteryWaring;
        };
      ...
      private:
        ...
        static constexpr auto bottom_description_max_size_w = 900U; // TODO: set it properly
